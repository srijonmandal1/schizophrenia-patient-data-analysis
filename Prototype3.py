...
def display_home():
    ...
    if selected_patient:
        ...
        with col2:
            ...
            st.image("https://mail.google.com/mail/u/0?ui=2&ik=3a37770afa&attid=0.1&permmsgid=msg-a:r-8228753530922092587&th=18f28bfb5975492b&view=att&disp=safe&realattid=f_lvkmylri0", width = 500)
